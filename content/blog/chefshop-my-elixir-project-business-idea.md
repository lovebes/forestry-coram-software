...
Not only that, I'm creating one of the core sins of startup-building, not checking if there's demand, and only then build. No more "build first and then they will come". But in this case my argument is I am going to dogfood my creation. And also it's not like I didn't do the [research]({{< ref "/blog/creating-a-product-competitor-research" >}} "Competitor Research")
